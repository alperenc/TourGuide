...
/**
 * {@AttractionLocation} represents an attraction location that the user would like to visit.
...
public class AttractionLocation {
    ...
    /**
     * Create a new AttractionLocation object.
     *
     ...
     */
    public AttractionLocation(int titleId, int addressId) {
     ...
     */
    public AttractionLocation(int titleId, int addressId, int imageResourceId) {
